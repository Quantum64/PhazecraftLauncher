...
public class OSUtils {
	...
	public static String getDynamicStorageLocation() {
		switch(getCurrentOS()) {
		case WINDOWS:
			return System.getenv("APPDATA") + "/phazecraftlauncher/";
		case MACOSX:
			return cachedUserHome + "/Library/Application Support/phazecraftlauncher/";
		case UNIX:
			return cachedUserHome + "/.phazecraftlauncher/";
		default:
