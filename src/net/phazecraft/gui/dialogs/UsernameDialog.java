...
public class UsernameDialog extends JDialog {
	...
	public UsernameDialog(LaunchFrame instance, boolean modal) {
		...
		login.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				if(!new String(password.getText()).isEmpty()){
					LaunchFrame.tmpUsername = new String(password.getText());
					setVisible(false);
				}
			}
		});
	...
	private void setupGui() {
		...
		passwordLbl = new JLabel("Please enter your Minecraft Username");
